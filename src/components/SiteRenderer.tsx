...
import type { SiteConfig, SiteContent } from "@/lib/types";

/**
 * Renders the whole landing page from a config + content pair. Used by the
 * static home page (build-time JSON) and by /demo (live client state).
 */
export function SiteRenderer({ config, content }: { config: SiteConfig; content: SiteContent }) {
